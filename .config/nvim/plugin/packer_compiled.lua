...
_G.packer_plugins = {
  ["auto-session"] = {
    ...
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/auto-session",
  ...
  gruvbox = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  neoformat = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/neoformat",
    url = "https://github.com/sbdchd/neoformat"
  },
  neogit = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/neogit",
    url = "https://github.com/TimUntersberger/neogit"
  },
  ["nord-vim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/nord-vim",
  ...
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils",
  ...
  ["palenight.vim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/palenight.vim",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/prettier.nvim",
  ...
  ["telescope-project.nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/telescope-project.nvim",
  ...
  ["vim-rails"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-rails",
    url = "https://github.com/tpope/vim-rails"
  },
  ["vim-slim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-slim",
